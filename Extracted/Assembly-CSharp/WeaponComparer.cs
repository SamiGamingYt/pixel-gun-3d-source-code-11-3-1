...
{
	// Token: 0x06004B3A RID: 19258 RVA: 0x001ADC04 File Offset: 0x001ABE04
	public int Compare(object x, object y)
	{
		...
		return Array.IndexOf<string>(WeaponComparer.multiplayerWeaponsOrd, tag2).CompareTo(Array.IndexOf<string>(WeaponComparer.multiplayerWeaponsOrd, tag));
	}
